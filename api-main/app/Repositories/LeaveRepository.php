...
class LeaveRepository extends BaseRepository
{
    ...
    public function search($params)
    {
        ...
        if (isset($params['user_id'])) {
            $conditionsFormated[] = ['user_id', '=', $params['user_id']];
        }
        ...
        if (isset($params['to_approve_id'])) {
            $conditionsFormated[] = ['to_approve_id', '=', $params['to_approve_id']];
        }
        if (isset($params['approve_id'])) {
            $conditionsFormated[] = ['approve_id', '=', $params['approve_id']];
        }
        if (isset($params['duration'])) {
            $conditionsFormated[] = ['duration', '=', $params['duration']];
        }
        if (isset($params['month'])) {
            $conditionsFormated[] = ['month', '=', $params['month']];
        }
        if (isset($params['status_code'])) {
            $conditionsFormated[] = ['status_code', '=', $params['status_code']];
        }
