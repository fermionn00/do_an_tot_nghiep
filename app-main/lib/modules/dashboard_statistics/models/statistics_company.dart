...
StatisticCompany statisticCompanyFromJson(Map<String, dynamic> str) =>
    StatisticCompany.fromJson(str);

String statisticCompanyToJson(StatisticCompany data) =>
...
class StatisticCompany {
  ...
  factory StatisticCompany.fromJson(Map<String, dynamic> json) =>
      StatisticCompany(
        checkins: json["time_checkin"],
