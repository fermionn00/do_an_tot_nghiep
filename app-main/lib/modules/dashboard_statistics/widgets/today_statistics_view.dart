                  ...
                  child: Row(
                    ...
                    children: [
                      BaseCardStatistics(
                        ...
                        endColor:
                            AppColor.colorStatisticsCheckinToday.withAlpha(
                          (0.5 * 255).round(),
                        ),
                  ...
                  child: Row(
                    ...
                    children: [
                      BaseCardStatistics(
                        ...
                        endColor: AppColor.colorStatisticsAbsentToday.withAlpha(
                          (0.5 * 255).round(),
                        ),
                        icon: SvgPicture.asset(
                      ...
                      BaseCardStatistics(
                        ...
                        endColor:
                            AppColor.colorStatisticsCasualLeaveToday.withAlpha(
                          (0.5 * 255).round(),
                        ),
                        icon: SvgPicture.asset(
