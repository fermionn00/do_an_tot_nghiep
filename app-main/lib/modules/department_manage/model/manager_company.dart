...
List<ManagerCompany> managerCompanyFromJson(List<dynamic> str) => List<ManagerCompany>.from(str.map((x) => ManagerCompany.fromJson(x)));

String managerCompanyToJson(List<ManagerCompany> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class ManagerCompany {
    ...
    factory ManagerCompany.fromJson(Map<String, dynamic> json) => ManagerCompany(
        id: json["id"],
        name: json["name"],
