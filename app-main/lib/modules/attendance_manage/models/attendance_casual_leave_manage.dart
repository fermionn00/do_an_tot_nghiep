...
List<AttendanceCasualLeave> attendanceCasualLeaveFromJson(List<dynamic> str) => List<AttendanceCasualLeave>.from(str.map((x) => AttendanceCasualLeave.fromJson(x)));

String attendanceCasualLeaveToJson(List<AttendanceCasualLeave> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class AttendanceCasualLeave {
    int? id;
    int? userId;
    int? companyId;
    int? toApproveId;
    ...
    factory AttendanceCasualLeave.fromJson(Map<String, dynamic> json) => AttendanceCasualLeave(
        id: json["id"],
        userId: json["user_id"],
